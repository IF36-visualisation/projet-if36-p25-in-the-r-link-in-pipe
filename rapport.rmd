...
### 1. Insertion des graphiques détaillés, mode par mode pour avoir plus de mode de jeux
...
L’analyse des temps de complétion par plateforme, à travers ces visualisations complémentaires, nous permet de dire :
...
graphe_final_avis <- grid.arrange(graphe_top10_presse, graphe_top10_joueurs,
                                  graphe_min10_presse, graphe_min10_joueurs,
                                  graphe_plus_proches,
                                  nrow = 3)
```
